    ...
    <div className="flex items-center justify-between">
      ...
      <Link href="/" className="flex items-center gap-2 hover:opacity-80 transition-opacity">
        <Image
          ...
          priority
        />
        <span className="text-lg font-serif font-bold text-primary">iWanderz</span>
      </Link>

      {/* Login on the right */}
      <div>
        {loading ? (
          <div className="w-24 h-10 bg-stone-100/50 animate-pulse rounded-lg" />
        ) : user ? (
          <div className="relative" ref={dropdownRef}>
            ...
            {dropdownOpen && (
              <div className="absolute right-0 mt-2 w-48 bg-white/90 backdrop-blur-xl border border-white/30 rounded-lg shadow-lg py-1 z-[110]">
                <Link
                  href="/"
